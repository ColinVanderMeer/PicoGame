...
#define sound_i2s_16bits_wrap_target 0
#define sound_i2s_16bits_wrap 7
#define sound_i2s_16bits_pio_version 0

static const uint16_t sound_i2s_16bits_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program sound_i2s_16bits_program = {
    .instructions = sound_i2s_16bits_program_instructions,
    .length = 8,
    .origin = -1,
    .pio_version = 0,
...
static inline pio_sm_config sound_i2s_16bits_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + sound_i2s_16bits_wrap_target, offset + sound_i2s_16bits_wrap);
